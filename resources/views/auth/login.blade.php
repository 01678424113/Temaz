    ...
    <div class="row bs-reset">
        <div class="col-md-6 bs-reset mt-login-5-bsfix">
            <div class="login-bg" style="background-image:url(admin/assets/pages/img/login/bg1.jpg)">
                <img class="login-logo" src="admin/assets/pages/img/login/logo.png"/></div>
        </div>
        <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
            ...
            <div class="login-content">
                <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Đăng nhập') }}">
                    @csrf
                    <h1>Temaz Affiliate</h1>
                    <p>Đơn giản tiếp thị liên kết là một hình thức online marketing mà bạn sẽ nhận được hoa hồng khi giới thiệu một khách hàng tiềm năng hoặc bán thành công một sản phẩm cho nhà cung cấp.</p>
