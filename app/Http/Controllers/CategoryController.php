...
class CategoryController extends Controller
{
    ...
    public function addPhoneToCategory()
    {
        ...
        return view('page.category.addPhoneToCategory', compact('data','categories'));
    }

    public function doAddPhoneToCategory(Request $request)
    {
        if(!empty($request->phoneIds)){
            foreach ($request->phoneIds as $phoneId){
                $model = Phone::findOrFail($phoneId);
